 ...
 * main.c. This is the original kr260_hw_rtos implementation, verbatim
 * except for the test_* → mem_test_* rename and the move of tx_buf/rx_buf
 * to file scope (so main.c shares the same DMA buffers via memory.h).
 *
